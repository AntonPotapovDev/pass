...
pub const CMD_RSA_EXPORT: &str = "rsa_export";
pub const CMD_RSA_IMPORT: &str = "rsa_import";
...
pub fn resolve_command(cmd: &str) -> Result<Box<dyn builders::CmdBuilder>, ()> {
    match cmd {
        ...
        CMD_RSA_EXPORT => Ok(Box::new(builders::RSAExportBuilder)),
        CMD_RSA_IMPORT => Ok(Box::new(builders::RSAImportBuilder)),
        CMD_EXPORT => Ok(Box::new(builders::PassBasedExportBuilder)),
        CMD_IMPORT => Ok(Box::new(builders::PassBasedImportBuilder)),
